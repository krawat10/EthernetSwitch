...
namespace EthernetSwitch.Controllers
{
    public class SNMPController : Controller
    {
        ...
        public IActionResult SetSNMPv3()
        {
            return View(new SetSNMPv3ViewModel { IpAddress = HttpContext.Connection.LocalIpAddress.ToString() });
        }
        ...
        [HttpPost]
        public IActionResult SetSNMPv3(SetSNMPv3ViewModel viewModel)
        {
            var ipAddress = IPAddress.Parse(viewModel.IpAddress);
            viewModel.Error = "";
